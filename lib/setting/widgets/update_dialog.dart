...
class _UpdateDialogState extends State<UpdateDialog> {
  ...
  Future<void> _download() async {
    try {
      ...
      final String basePath = externalDir?.path ?? (await getApplicationDocumentsDirectory()).path;
      final Directory downloadDir = Directory('$basePath/Download');
      if (!downloadDir.existsSync()) {
        downloadDir.createSync(recursive: true);
      }
      final String path = '${downloadDir.path}/deer.apk';
