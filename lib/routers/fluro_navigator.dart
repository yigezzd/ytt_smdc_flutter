...
class NavigatorUtils {
  ...
  /// 跳到本地资产HTML页
  static void goAssetHtmlPage(BuildContext context, String title, String assetPath) {
    push(context, '${Routes.webViewPage}?title=${Uri.encodeComponent(title)}&url=${Uri.encodeComponent(assetPath)}&isAsset=true');
  }
